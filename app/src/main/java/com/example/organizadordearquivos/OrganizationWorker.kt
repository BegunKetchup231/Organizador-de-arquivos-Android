...
class OrganizationWorker(appContext: Context, workerParams: WorkerParameters) :
    ...
    companion object {
        // Chaves para passar dados para o Worker e para receber o progresso
    ...
    override suspend fun doWork(): Result {
        // Pega os dados que a MainActivity enviou (qual operação e qual pasta)
        ...
        when (operationType) {
            ...
            // No futuro, adicionaremos os outros casos aqui (organizar por data, etc.)
        }
